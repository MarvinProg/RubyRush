...
for item in question do 
  ...
  while user_ansver != "yes" and user_ansver != "no" do 
    puts "Введите yes or no"
    user_ansver = STDIN.gets.chomp.downcase
  end
...
puts "Ваш результат: #{yes_ansver} da"

if yes_ansver >= 10
  puts results[0]
elsif yes_ansver >= 5 and yes_ansver < 10
  puts results[1]
else 
  puts results[2]
end